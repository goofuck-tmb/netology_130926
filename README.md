...
Terraform с рабочей станции управляет docker на ВМ через SSH (`host = "ssh://..."`). Поднял `mysql:8`, пароли через `random_password`. Код также в [`task2/main.tf`](task2/main.tf):
